...
function Navbar() {
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="#">Vaibhav Industries</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <a class="btn btn-outline-primary mx-2" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
  <div class="offcanvas-header">
    <h5 class="offcanvas-title" id="offcanvasExampleLabel">Vaibhav Industries</h5>
  ...
  <div class="offcanvas-body">
    ...
    <div class="dropdown mt-3">
      ...
      <ul class="dropdown-menu">
        <li><a class="dropdown-item" href="#">Be a member</a></li>
        <li><a class="dropdown-item" href="#">Buy gold membership</a></li>
        <li><a class="dropdown-item" href="#">Elite pass</a></li>
      </ul>
    </div>
  </div>
</div>
